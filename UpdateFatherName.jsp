...
<meta charset="UTF-8">
<title>Update Father Name</title>
</head>
<header>
...
%>
	<div class="container">
		...
		<form action ="UpdateFatherNameServlet" method="post">
			<label for="rollno">Father's Name:</label> <input type="text"
				id="fathername" name="fathername" placeholder="Enter new father name of student " required><br>
			<br>
