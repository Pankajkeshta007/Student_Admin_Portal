...
%>
	<div class="container">
		...
		<form action ="UpdateContactNoServlet" method="post">
			<label for="rollno">Contact No:</label> <input type="text"
				id="contactno" name="contactno" placeholder="Enter new contact no. of student " required><br>
			<br>
